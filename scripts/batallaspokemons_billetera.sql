...
CREATE TABLE `billetera` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKq4r9xa38kjuqeyec15g397t7r` (`usuario_id`),
  CONSTRAINT `FKq4r9xa38kjuqeyec15g397t7r` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `billetera` VALUES (3,4000,1);
