		...
		<form:form action="batalla" method="POST" modelAttribute="pokemon"
			...
			<div class="formP">
				<div class="form">
					...
					<h3 class="fs-5 text mb-3">Seleccione 3 Pokémons para la batalla</h3>
					<div
						...
						<c:forEach items="${listaPokemon}" var="pokemon">
							<div class="d-flex flex-column align-items-center"
								...
								<button type="button" style="width: 105px;"
									class="btn btn-primary botonPokemon">Seleccionar</button>
				...
				<div class="form">
					...
					<div
						...
						<c:forEach items="${listaObjetos}" var="objeto">
							<div class="d-flex flex-column align-items-center"
								style="width: 33%;">
								<img alt="${objeto.nombre}" class="img-fluid mb-2" style="height: 70px;"
