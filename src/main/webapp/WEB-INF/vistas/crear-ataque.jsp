	...
	<div class="container">
		<div id="loginbox" style="margin-top: 50px;"
			...
			<form:form action="guardar-ataque" method="POST"	
				...
				<form:input path="potencia" id="potencia" class="form-control" /><br>
				<label>Precision</label>
				<form:input path="precataque" id="precataque" class="form-control" /><br>
				<label>Pp's</label>
				<form:input path="pp" id="pp" class="form-control" /><br>
				<div class="form-check">
					<label class="form-check-label">Efecto</label>
					<form:checkbox class="form-check-input" path="efecto" id="efecto"/><br>
				</div>
