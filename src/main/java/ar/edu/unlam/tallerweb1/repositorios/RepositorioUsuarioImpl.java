...
public class RepositorioUsuarioImpl implements RepositorioUsuario {
	...
	public Usuario buscarUsuario(String email, String password) {
		...
		//password = hashUtil(password, this.buscar(email).getSalt()); //Buscar hash de la contrase�a
	...
	public void guardar(Usuario usuario) {
		...
		usuario.setPassword(hashUtil(usuario.getPassword(), salt));*/ //Guardando un hash seguro de la contrase�a del usuario
	...
	// Este c�digo sirve para crear un hash seguro y almacenarlo en la bd en lugar de la contrase�a, como no es requerido en la materia no lo implement�
